...
function stampGen(pokemonId) {
    ...
    } else if (pokemonId >= 494 && pokemonId <= 649) {document.addEventListener("DOMContentLoaded", function () {
        const pokemonList = document.getElementById("pokemonList");
        const pokemonInfoContainer = document.getElementById("pokemonInfoContainer");
        const exitButton = document.getElementById("exitButton");
                        ...
                        fetch(`https://pokeapi.co/api/v2/pokemon-species/${pokemonId}/`)
                            ...
                            .then(categoryData => {
                                ...
                                if (genStamp) {
                                    ...
                                    console.error("No se encontró el elemento .genStamp");
                                }
    
                                pokemonInfoContainer.style.zIndex = "1";
    ...
    function stampGen(pokemonId) {
        ...
        } else if (pokemonId >= 810 && pokemonId <= 905) {
            genStampText.textContent = "Gen 8";
        } else if (pokemonId >= 906 && pokemonId <= 1025) {
